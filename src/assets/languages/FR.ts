...
export const FR: LanguageType = {
  ...
  messages: {
    ...
    PASSWORD_IS_INVALID: "Le mot de passe est invalide!",
    UPDATE_FAILED: "Échec de la mise à jour!",
    UPDATE_SUCCESSFUL: "Mise à jour réussie!",
    TOKEN_NOT_PROVIDED: "Token non four",
    ...
    MACHINE_DELETE_SUCCESSFUL: "Machine supprimée avec succès!",
    MACHINE_UPDATE_FAILED: "Erreur lors de la mise à jour de la machine!",
    MACHINE_UPDATE_SUCCESSFUL: "Machine mise à jour avec succès!",
  },
};
