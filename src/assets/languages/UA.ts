...
export const UA: LanguageType = {
  ...
  messages: {
    ...
    EMAIL_ALREADY_EXISTS: "Електронна пошта вже існує!",
    ...
    PASSWORD_IS_INVALID: "Пароль недійсний!",
    UPDATE_FAILED: "Оновлення не вдалося!",
    UPDATE_SUCCESSFUL: "Оновлення успішне!",
    TOKEN_NOT_PROVIDED: "Токен не наданий!",
    ...
    MACHINE_DELETE_SUCCESSFUL: "Машина успішно видалена!",
    MACHINE_UPDATE_FAILED: "Помилка оновлення машини!",
    MACHINE_UPDATE_SUCCESSFUL: "Машина успішно оновлена!",
  },
};
