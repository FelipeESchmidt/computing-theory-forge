...
export const NO: LanguageType = {
  ...
  messages: {
    ...
    EMAIL_ALREADY_EXISTS: "E-posten eksisterer allerede!",
    ...
    PASSWORD_IS_INVALID: "Passordet er ugyldig!",
    UPDATE_FAILED: "Oppdatering mislyktes!",
    UPDATE_SUCCESSFUL: "Oppdatering vellykket!",
    TOKEN_NOT_PROVIDED: "Token ikke gitt!",
    ...
    MACHINE_DELETE_SUCCESSFUL: "Maskin slettet vellykket!",
    MACHINE_UPDATE_FAILED: "Feil ved oppdatering av maskin!",
    MACHINE_UPDATE_SUCCESSFUL: "Maskin oppdatert vellykket!",
  },
};
