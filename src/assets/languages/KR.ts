...
export const KR: LanguageType = {
  ...
  messages: {
    ...
    PASSWORD_IS_INVALID: "비밀번호가 잘못되었습니다!",
    ...
    MACHINE_DELETE_SUCCESSFUL: "기계가 성공적으로 삭제되었습니다!",
    MACHINE_UPDATE_FAILED: "기계 업데이트 중 오류 발생!",
    MACHINE_UPDATE_SUCCESSFUL: "기계가 성공적으로 업데이트되었습니다!",
  },
};
